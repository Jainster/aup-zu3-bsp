...
if { $list_projs eq "" } {
   create_project hw hw -part xczu3eg-sfvc784-2-e
}
...
proc create_hier_cell_audio { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 aic_dma

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 aic_dma_ctrl_i
  ...
  create_bd_pin -dir O -type intr aic_mm2s_irq_o
  create_bd_pin -dir O -type intr aic_s2mm_irq_o
  ...
  set axi_iic_aic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:* axi_iic_aic ]
  ...
  set mclk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:* mclk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {377.853} \
   CONFIG.CLKOUT1_PHASE_ERROR {474.126} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {18.432} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {88.750} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {53.500} \
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins i2s_rx_s_axi_ctrl_i] [get_bd_intf_pins i2s_receiver_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins i2s_tx_s_axi_ctrl_i] [get_bd_intf_pins i2s_transmitter_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins AIC_nRST] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins axi_gpio_ctrl_i] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins i2c_aic] [get_bd_intf_pins axi_iic_aic/IIC]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins axi_i2c_ctrl_i] [get_bd_intf_pins axi_iic_aic/S_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins aic_dma] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net aic_dma_ctrl_i_1 [get_bd_intf_pins aic_dma_ctrl_i] [get_bd_intf_pins audio_formatter_0/s_axi_lite]
  connect_bd_intf_net -intf_net audio_formatter_0_m_axi_mm2s [get_bd_intf_pins audio_formatter_0/m_axi_mm2s] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net audio_formatter_0_m_axi_s2mm [get_bd_intf_pins audio_formatter_0/m_axi_s2mm] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_ctrl_clk_i] [get_bd_pins audio_formatter_0/m_axis_mm2s_aclk] [get_bd_pins audio_formatter_0/s_axi_lite_aclk] [get_bd_pins audio_formatter_0/s_axis_s2mm_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_aic/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins i2s_receiver_0/m_axis_aud_aclk] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aclk] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aclk] [get_bd_pins i2s_transmitter_0/s_axis_aud_aclk] [get_bd_pins mclk_wiz_0/clk_in1]
  connect_bd_net -net Net1 [get_bd_pins axi_ctrl_nrst_i] [get_bd_pins audio_formatter_0/m_axis_mm2s_aresetn] [get_bd_pins audio_formatter_0/s_axi_lite_aresetn] [get_bd_pins audio_formatter_0/s_axis_s2mm_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_aic/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins i2s_receiver_0/m_axis_aud_aresetn] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aresetn] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aresetn] [get_bd_pins i2s_transmitter_0/s_axis_aud_aresetn] [get_bd_pins mclk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net aud_mrst_0_1 [get_bd_pins audio_formatter_0/aud_mreset] [get_bd_pins i2s_receiver_0/aud_mrst] [get_bd_pins i2s_transmitter_0/aud_mrst] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net audio_formatter_0_irq_mm2s [get_bd_pins aic_mm2s_irq_o] [get_bd_pins audio_formatter_0/irq_mm2s]
  connect_bd_net -net audio_formatter_0_irq_s2mm [get_bd_pins aic_s2mm_irq_o] [get_bd_pins audio_formatter_0/irq_s2mm]
  connect_bd_net -net axi_iic_aic_iic2intc_irpt [get_bd_pins iic2intc_irpt] [get_bd_pins axi_iic_aic/iic2intc_irpt]
  connect_bd_net -net i2s_receiver_0_irq [get_bd_pins i2s_rx_irq_o] [get_bd_pins i2s_receiver_0/irq]
  connect_bd_net -net i2s_transmitter_0_irq [get_bd_pins i2s_tx_irq_o] [get_bd_pins i2s_transmitter_0/irq]
  connect_bd_net -net i2s_transmitter_0_lrclk_out [get_bd_pins lrclk_o] [get_bd_pins i2s_transmitter_0/lrclk_out]
  connect_bd_net -net i2s_transmitter_0_sclk_out [get_bd_pins sclk_o] [get_bd_pins i2s_transmitter_0/sclk_out]
  connect_bd_net -net i2s_transmitter_0_sdata_0_out [get_bd_pins i2s_tx_sdata_o] [get_bd_pins i2s_transmitter_0/sdata_0_out]
  connect_bd_net -net mclk_wiz_0_clk_out1 [get_bd_pins AIC_mclk_o] [get_bd_pins audio_formatter_0/aud_mclk] [get_bd_pins i2s_receiver_0/aud_mclk] [get_bd_pins i2s_transmitter_0/aud_mclk] [get_bd_pins mclk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net sdata_0_in_0_1 [get_bd_pins i2s_rx_sdata_i] [get_bd_pins i2s_receiver_0/sdata_0_in]
...
proc create_root_design { parentCell } {
  ...
  set JA [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 JA ]

  set JAB [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 JAB ]

  set JB [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 JB ]

  set PL_GRV [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 PL_GRV ]

  set RBP_GPIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 RBP_GPIO ]
  ...
  set CAM0_IN [ create_bd_port -dir I -from 4 -to 0 CAM0_IN ]
  set CAM0_OUT [ create_bd_port -dir O -from 3 -to 0 CAM0_OUT ]
  set PL_LEDRGB0 [ create_bd_port -dir O -from 2 -to 0 PL_LEDRGB0 ]
  set PL_LEDRGB1 [ create_bd_port -dir O -from 2 -to 0 PL_LEDRGB1 ]
  set PL_LEDRGB2 [ create_bd_port -dir O -from 2 -to 0 PL_LEDRGB2 ]
  set PL_LEDRGB3 [ create_bd_port -dir O -from 2 -to 0 PL_LEDRGB3 ]
  set PL_USER_LED [ create_bd_port -dir O -from 7 -to 0 PL_USER_LED ]
  set PL_USER_PB [ create_bd_port -dir I -from 3 -to 0 PL_USER_PB ]
  set PL_USER_SW [ create_bd_port -dir I -from 7 -to 0 PL_USER_SW ]
  set SEL_JOYSTICK [ create_bd_port -dir O -from 0 -to 0 SEL_JOYSTICK ]
  set SERVO [ create_bd_port -dir O -from 3 -to 0 SERVO ]
  ...
  # Create instance: Pmod_JA, and set properties
  set Pmod_JA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:* Pmod_JA ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {8} \
 ] $Pmod_JA

  # Create instance: Pmod_JAB, and set properties
  set Pmod_JAB [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:* Pmod_JAB ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {6} \
 ] $Pmod_JAB

  # Create instance: Pmod_JB, and set properties
  set Pmod_JB [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:* Pmod_JB ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {8} \
 ] $Pmod_JB
  ...
  # Create instance: cam0_slice, and set properties
  set cam0_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* cam0_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {37} \
   CONFIG.DIN_TO {34} \
   CONFIG.DIN_WIDTH {64} \
  ...
  set gpio_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:* gpio_concat ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {6} \
 ] $gpio_concat

  # Create instance: gpio_out0_constant, and set properties
  set gpio_out0_constant [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:* gpio_out0_constant ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {20} \
 ] $gpio_out0_constant

  # Create instance: gpio_out1_constant, and set properties
  set gpio_out1_constant [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:* gpio_out1_constant ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {6} \
 ] $gpio_out1_constant

  # Create instance: gpio_out2_constant, and set properties
  set gpio_out2_constant [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:* gpio_out2_constant ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {21} \
 ] $gpio_out2_constant

  # Create instance: grove_gpio, and set properties
  set grove_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:* grove_gpio ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {4} \
   CONFIG.C_IS_DUAL {0} \
 ] $grove_gpio

  # Create instance: joystick_slice, and set properties
  set joystick_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* joystick_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {32} \
   CONFIG.DIN_TO {32} \
   CONFIG.DIN_WIDTH {64} \
  ...
  set led_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* led_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: rbp_gpio, and set properties
  set rbp_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:* rbp_gpio ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {28} \
 ] $rbp_gpio

  # Create instance: rgb0_slice, and set properties
  set rgb0_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* rgb0_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {10} \
   CONFIG.DIN_TO {8} \
   CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: rgb1_slice, and set properties
  set rgb1_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* rgb1_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {13} \
   CONFIG.DIN_TO {11} \
   CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: rgb2_slice, and set properties
  set rgb2_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* rgb2_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {16} \
   CONFIG.DIN_TO {14} \
   CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: rgb3_slice, and set properties
  set rgb3_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:* rgb3_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {19} \
   CONFIG.DIN_TO {17} \
   CONFIG.DIN_WIDTH {64} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_29_DRIVE_STRENGTH {2} \
   ...
   CONFIG.PSU_MIO_31_DRIVE_STRENGTH {2} \
   ...
   CONFIG.PSU_MIO_45_DRIVE_STRENGTH {2} \
...
GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0\
MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#SD 0#SD 0#GPIO0\
MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#GPIO0 MIO#SD 0#GPIO0 MIO#GPIO1\
MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#UART 1#UART 1#I2C 0#I2C 0#I2C 1#I2C\
1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1\
MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#USB 0#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 1#USB 1#USB 1#USB\
1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB0 Reset#GPIO2 MIO} \
...
gpio0[0]#gpio0[1]#gpio0[2]#gpio0[3]#gpio0[4]#gpio0[5]#gpio0[6]#gpio0[7]#gpio0[8]#gpio0[9]#gpio0[10]#gpio0[11]#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#sdio0_cmd_out#sdio0_clk_out#gpio0[23]#sdio0_cd_n#gpio0[25]#gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#txd#rxd#scl_out#sda_out#scl_out#sda_out#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#gpio1[44]#gpio1[45]#gpio1[46]#gpio1[47]#gpio1[48]#gpio1[49]#gpio1[50]#gpio1[51]#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#reset#gpio2[77]} \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {199.999954} \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {9.999999} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Pmod_JAB_GPIO [get_bd_intf_ports JAB] [get_bd_intf_pins Pmod_JAB/GPIO]
  connect_bd_intf_net -intf_net Pmod_JB_GPIO [get_bd_intf_ports JB] [get_bd_intf_pins Pmod_JB/GPIO]
  connect_bd_intf_net -intf_net Vp_Vn_0_1 [get_bd_intf_ports Vp_Vn] [get_bd_intf_pins system_management_wiz_0/Vp_Vn]
  connect_bd_intf_net -intf_net audio_aic_dma [get_bd_intf_pins audio/aic_dma] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net audio_i2c_aic [get_bd_intf_ports i2c_aic] [get_bd_intf_pins audio/i2c_aic]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports PL_GRV] [get_bd_intf_pins grove_gpio/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_ja [get_bd_intf_ports JA] [get_bd_intf_pins Pmod_JA/GPIO]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins Pmod_JA/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins Pmod_JB/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins Pmod_JAB/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins rbp_gpio/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins system_management_wiz_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins ps8_0_axi_periph/M07_AXI] [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins grove_gpio/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins audio/i2s_rx_s_axi_ctrl_i] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins audio/i2s_tx_s_axi_ctrl_i] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins audio/axi_gpio_ctrl_i] [get_bd_intf_pins ps8_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M12_AXI [get_bd_intf_pins audio/axi_i2c_ctrl_i] [get_bd_intf_pins ps8_0_axi_periph/M12_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M13_AXI [get_bd_intf_pins audio/aic_dma_ctrl_i] [get_bd_intf_pins ps8_0_axi_periph/M13_AXI]
  connect_bd_intf_net -intf_net rbp_gpio_GPIO [get_bd_intf_ports RBP_GPIO] [get_bd_intf_pins rbp_gpio/GPIO]
  connect_bd_intf_net -intf_net v_frmbuf_wr_0_m_axi_mm_video [get_bd_intf_pins v_frmbuf_wr_0/m_axi_mm_video] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  ...
  # Create port connections
  connect_bd_net -net CAM0_INPUT_1 [get_bd_ports CAM0_IN] [get_bd_pins gpio_concat/In4]
  connect_bd_net -net PL_USER_PB_1 [get_bd_ports PL_USER_PB] [get_bd_pins gpio_concat/In1]
  connect_bd_net -net PL_USER_SW_1 [get_bd_ports PL_USER_SW] [get_bd_pins gpio_concat/In2]
  connect_bd_net -net PWM_0_pwm [get_bd_ports SERVO] [get_bd_pins PWM_0/pwm]
  connect_bd_net -net audio_AIC_mclk_o [get_bd_ports AIC_mclk_o] [get_bd_pins audio/AIC_mclk_o]
  connect_bd_net -net audio_AIC_nRST_tri_o [get_bd_ports AIC_nRST] [get_bd_pins audio/AIC_nRST_tri_o]
  connect_bd_net -net audio_aic_mm2s_irq_o [get_bd_pins audio/aic_mm2s_irq_o] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net audio_aic_s2mm_irq_o [get_bd_pins audio/aic_s2mm_irq_o] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net audio_i2s_rx_irq_o [get_bd_pins audio/i2s_rx_irq_o] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net audio_i2s_tx_irq_o [get_bd_pins audio/i2s_tx_irq_o] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net audio_i2s_tx_sdata_o [get_bd_ports AIC_sdata_o] [get_bd_pins audio/i2s_tx_sdata_o]
  connect_bd_net -net audio_iic2intc_irpt [get_bd_pins audio/iic2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net audio_lrclk_o [get_bd_ports AIC_lrclk_o] [get_bd_pins audio/lrclk_o]
  connect_bd_net -net audio_sclk_o [get_bd_ports AIC_sclk_o] [get_bd_pins audio/sclk_o]
  connect_bd_net -net cam0_slice_Dout [get_bd_ports CAM0_OUT] [get_bd_pins cam0_slice/Dout]
  connect_bd_net -net gpio_concat_dout [get_bd_pins gpio_concat/dout] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_i]
  connect_bd_net -net gpio_out2_constant_dout [get_bd_pins gpio_concat/In5] [get_bd_pins gpio_out2_constant/dout]
  connect_bd_net -net gpio_unused_constant_dout [get_bd_pins gpio_concat/In3] [get_bd_pins gpio_out1_constant/dout]
  connect_bd_net -net i2s_rx_sdata_i_0_1 [get_bd_ports AIC_sdata_i] [get_bd_pins audio/i2s_rx_sdata_i]
  connect_bd_net -net joystick_slice_Dout [get_bd_ports SEL_JOYSTICK] [get_bd_pins joystick_slice/Dout]
  connect_bd_net -net rgb1_slice_Dout [get_bd_ports PL_LEDRGB1] [get_bd_pins rgb1_slice/Dout]
  connect_bd_net -net rgb3_slice_Dout [get_bd_ports PL_LEDRGB3] [get_bd_pins rgb3_slice/Dout]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins PWM_0/pwm_axi_aresetn] [get_bd_pins Pmod_JA/s_axi_aresetn] [get_bd_pins Pmod_JAB/s_axi_aresetn] [get_bd_pins Pmod_JB/s_axi_aresetn] [get_bd_pins audio/axi_ctrl_nrst_i] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins grove_gpio/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/M11_ARESETN] [get_bd_pins ps8_0_axi_periph/M12_ARESETN] [get_bd_pins ps8_0_axi_periph/M13_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rbp_gpio/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
  connect_bd_net -net system_management_wiz_0_ip2intc_irpt [get_bd_pins system_management_wiz_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins gpio_concat/In0] [get_bd_pins gpio_out0_constant/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports PL_USER_LED] [get_bd_pins led_slice/Dout]
  connect_bd_net -net xlslice_0_Dout1 [get_bd_ports PL_LEDRGB0] [get_bd_pins rgb0_slice/Dout]
  connect_bd_net -net xlslice_0_Dout2 [get_bd_ports PL_LEDRGB2] [get_bd_pins rgb2_slice/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins cam0_slice/Din] [get_bd_pins joystick_slice/Din] [get_bd_pins led_slice/Din] [get_bd_pins rgb0_slice/Din] [get_bd_pins rgb1_slice/Din] [get_bd_pins rgb2_slice/Din] [get_bd_pins rgb3_slice/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PWM_0/pwm_axi_aclk] [get_bd_pins Pmod_JA/s_axi_aclk] [get_bd_pins Pmod_JAB/s_axi_aclk] [get_bd_pins Pmod_JB/s_axi_aclk] [get_bd_pins audio/axi_ctrl_clk_i] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins grove_gpio/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/M11_ACLK] [get_bd_pins ps8_0_axi_periph/M12_ACLK] [get_bd_pins ps8_0_axi_periph/M13_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rbp_gpio/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_management_wiz_0/s_axi_aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PWM_0/PWM_AXI/PWM_AXI_reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Pmod_JAB/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Pmod_JA/S_AXI/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Pmod_JB/S_AXI/Reg] -force
  assign_bd_address -offset 0x800D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/audio_formatter_0/s_axi_lite/reg0] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs grove_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x800B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/i2s_receiver_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x800C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/i2s_transmitter_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rbp_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_mm2s] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_s2mm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_mm2s] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_mm2s] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_s2mm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces audio/audio_formatter_0/m_axi_s2mm] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
...
add_files -fileset constrs_1 -norecurse constraints/mpsoc.xdc

# Create top level
make_wrapper -files [get_files hw/hw.srcs/sources_1/bd/hw/hw.bd] -top
add_files -norecurse hw/hw.gen/sources_1/bd/hw/hdl/hw_wrapper.v
